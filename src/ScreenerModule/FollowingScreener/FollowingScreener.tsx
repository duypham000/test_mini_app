...
const FollowingScreener: React.FC = (): JSX.Element => {
  // useState
  ...
  return (
    <ScreenerLayout hasHeader={false}>
      <div css={{ marginBottom: 4 }}>
        ...
        >{`Bộ lọc bạn đang theo dõi`}</Typography>
      </div>
      <div css={{ marginBottom: 32 }}>
        ...
        >{`Các bộ lọc công khai bạn đang theo dõi`}</Typography>
      </div>
      {/* <ReactInfiniteScroll
        ...
        > */}
      <FollowingTable data={DATA} />
      {/* </ReactInfiniteScroll> */}
    </ScreenerLayout>
  )
}

export default FollowingScreener
