...
export const NavWatchlistIcon = React.forwardRef<any, SVGProps<SVGSVGElement>>(
  (props, ref) => {
    return (
      <svg
        {...props}
      ...
      >
        <g clipPath="url(#clip0_15195_2764)">
          <path
...
if (process.env.NODE_ENV !== 'production') {
  NavWatchlistIcon.displayName = 'NavWatchlistIcon';
}
