...
export const NavWatchlistActiveIcon = React.forwardRef<
  any,
...
>((props, ref) => {
  return (
    ...
    >
      <g clipPath="url(#clip0_15212_7150)">
        <path
...
if (process.env.NODE_ENV !== 'production') {
  NavWatchlistActiveIcon.displayName = 'NavWatchlistActiveIcon';
}
