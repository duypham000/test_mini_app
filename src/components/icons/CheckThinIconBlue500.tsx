...
export const CheckThinIconBlue500 = React.forwardRef<
  any,
...
if (process.env.NODE_ENV !== 'production') {
  CheckThinIconBlue500.displayName = 'CheckThinIconBlue500';
}
