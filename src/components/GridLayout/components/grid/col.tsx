...
export interface ColProps extends React.HTMLAttributes<HTMLDivElement> {
  ...
  mobile?: ColSpanType | ColSize;
  tablet?: ColSpanType | ColSize;
  desktop?: ColSpanType | ColSize;
  prefixCls?: string;
}
...
const Col = React.forwardRef<HTMLDivElement, ColProps>((props, ref) => {
  ...
  if (gutter) {
    mergedStyle = {
      ...(gutter[0] && gutter[0] > 0
        ? {
            paddingLeft: gutter[0] && gutter[0] / 2,
            paddingRight: gutter[0] && gutter[0] / 2,
          }
        : {}),
      ...(gutter[1] && gutter[1] > 0
        ? {
            paddingTop: gutter[1] && gutter[1] / 2,
            paddingBottom: gutter[1] && gutter[1] / 2,
          }
        : {}),
      ...mergedStyle,
    };
